...
| `chapter2_time_series.py` | Глава 2. Первичный анализ временных рядов | CWRU Bearing Dataset ([Kaggle](https://www.kaggle.com/datasets/sufian79/cwru-mat-full-dataset)) |
